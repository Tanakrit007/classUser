...
// สร้าง User
const user1 = new user_1.default("U001", "John", "john@example.com", "User", "1234");
...
// สร้าง Instructor
const instructor1 = new Instructor_1.Instructor("I001", "Alice", "alice@example.com", "passAlice");
// ทดสอบ register, login, logout
...
// สร้าง Participant
const participant1 = new Participant_1.Participant("P001", "Bob", "bob@example.com", "passBob");
